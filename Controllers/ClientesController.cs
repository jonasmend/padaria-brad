...
namespace Padaria_Bread.Controllers
{
    ...
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,nome,data_nascimento,cpf,cep,rua,numero,bairro,complemento")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,nome,data_nascimento,cpf,cep,rua,numero,bairro,complemento")] Cliente cliente)
        {
            if (id != cliente.id)
            {
                return NotFound();
